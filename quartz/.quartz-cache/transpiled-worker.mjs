              ...
              if (match && match.input) {
                ...
                const titleNode = {
                  ...
                  children: [
                    {
                      type: "text",
                      value: useDefaultTitle ? capitalize(
                        i18n(cfg.locale).components.callout[calloutType] ?? calloutType
                      ) : titleContent + " "
                    },
                    ...restOfTitle
                  ]
...
import { Fragment as Fragment3, jsx as jsx15, jsxs as jsxs8 } from "preact/jsx-runtime";
var Head_default = /* @__PURE__ */ __name(() => {
  const Head = /* @__PURE__ */ __name(({ cfg, fileData, externalResources }) => {
    ...
    return /* @__PURE__ */ jsxs8("head", { children: [
      ...
      cfg.theme.cdnCaching && /* @__PURE__ */ jsxs8(Fragment3, { children: [
      ...
      /* @__PURE__ */ jsx15("link", { rel: "preconnect", href: "https://fonts.googleapis.com" }),
      /* @__PURE__ */ jsx15("link", { rel: "preconnect", href: "https://fonts.gstatic.com" }),
      /* @__PURE__ */ jsx15("link", { href: fontStylePath, rel: "stylesheet", type: "text/css", "spa-preserve": true }),
...
import { Fragment as Fragment4, jsx as jsx20, jsxs as jsxs10 } from "preact/jsx-runtime";
...
import { Fragment as Fragment5, jsx as jsx27 } from "preact/jsx-runtime";
var DesktopOnly_default = /* @__PURE__ */ __name((component) => {
  if (component) {
    ...
    return () => /* @__PURE__ */ jsx27(Fragment5, {});
  }
}, "default");
...
import { Fragment as Fragment7, jsx as jsx29, jsxs as jsxs16 } from "preact/jsx-runtime";
var defaultOptions13 = /* @__PURE__ */ __name((cfg) => ({
  limit: 3,
  linkToMore: false,
  filter: () => true,
...
var RecentNotes_default = /* @__PURE__ */ __name((userOpts) => {
  const RecentNotes = /* @__PURE__ */ __name(({
    ...
    const opts = { ...defaultOptions13(cfg), ...userOpts };
...
var sharedPageComponents = {
  ...
  footer: Footer_default({
    links: {
      GitHub: "https://github.com/ilikui",
      Twitter: "https://twitter.com/kico"
    }
  })
};
...
var config = {
  ...
  plugins: {
    transformers: [
      ...
      SyntaxHighlighting(),
      ObsidianFlavoredMarkdown({ enableInHtmlEmbed: false, parseTags: false }),
      GitHubFlavoredMarkdown(),
